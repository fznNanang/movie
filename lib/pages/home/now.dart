...
class _NowState extends State<Now> {
  ...
  // dialog simpan gambar ke penyimpanan internal
  ...
  Widget build(BuildContext context) {
    ...
    return 
    //cek data apakah kosong atau tidak dan tarik data dari API
    FutureBuilder<List<NowPlayModel>?>(
                future: HomeService.fetchPlayNow(),
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    List<NowPlayModel> itemsPopular = snapshot.data!.take(6).toList();
                        ...
                        setState(() {
                          ...
                          if (isWatchListPopular[index]) {
                            ...
                            currentWatchList = currentWatchList.where((item) {
                              // Memastikan item adalah Map dan memiliki properti 'id'
                    ...
                    return CarouselSlider.builder(
                      ...
                      itemBuilder: (context, index, realIndex) {
                        NowPlayModel data = itemsPopular[index];
